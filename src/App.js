...
import TrfProvider from './Components/Store/TrfProvider';
import ExcelUpload from './Components/TrainingRequestInitiator/ExcelUpload/ExcelUpload';
    ...
    <div>
      ...
      {/* <Router> */}
        <Routes>
          ...
          <Route exact path="/uploadexcel" element={<ExcelUpload />} />
          {/* <Route exact path="/trilist" element={<TRIList />} />         */}
        </Routes>
      {/* </Router> */}
      </TrfProvider>
    </div>
